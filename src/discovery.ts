...
export const reportDescription =
  ...
  'token metadata (name, symbol, decimals, total supply, verified status), ' +
  'deployer profile, holder count, top-10 holder concentration, deployer holdings, ' +
  'and an LP-lock heuristic. Address is supplied via the `:address` path parameter. ' +
